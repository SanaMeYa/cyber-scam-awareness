export const trainingModules = [
  {
    ...
    description: 'Inspect realistic inbox messages, choose safer emails, and trace how one phishing message can create company-wide damage.',
  ...
  },
  {
    ...
    description: 'Listen to realistic calls, challenge callers, build a safe callback route, and explore a branching conversation.',
    format: '5 interactive activities',
    available: true,
  },
  {
    id: 'teams',
...
export const getTrainingModule = (moduleId) => (
  trainingModules.find((module) => module.id === moduleId) ?? null
)
